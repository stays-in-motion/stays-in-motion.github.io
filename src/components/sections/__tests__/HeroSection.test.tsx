...
describe("HeroSection", () => {
  ...
  test("renders particle animations with correct positioning", () => {
    ...
    const particles = document.querySelectorAll('.animate-particle-float, .animate-particle-drift, .animate-particle-sway, .animate-particle-pulse');
  ...
  test("handles missing callback props gracefully", () => {
    ...
    const { container } = render(<HeroSection onDownloadClick={undefined as any} onLearnMoreClick={undefined as any} />);
