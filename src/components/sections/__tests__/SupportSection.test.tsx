...
mock.module("lucide-react", () => ({
  HelpCircle: ({ size, className }: { size?: number; className?: string }) => (
    <div data-testid="help-circle-icon" data-size={size} className={className}>HelpCircle</div>
  ),
  User: ({ size, className }: { size?: number; className?: string }) => (
    <div data-testid="user-icon" data-size={size} className={className}>User</div>
  ),
  Settings: ({ size, className }: { size?: number; className?: string }) => (
    <div data-testid="settings-icon" data-size={size} className={className}>Settings</div>
  ),
  Play: ({ size, className }: { size?: number; className?: string }) => (
    <div data-testid="play-icon" data-size={size} className={className}>Play</div>
  ),
  Mail: ({ size, className }: { size?: number; className?: string }) => (
    <div data-testid="mail-icon" data-size={size} className={className}>Mail</div>
  ),
