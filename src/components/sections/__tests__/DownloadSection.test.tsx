...
mock.module("lucide-react", () => ({
  Smartphone: ({ size, className }: { size?: number; className?: string }) => (
    <div data-testid="smartphone-icon" data-size={size} className={className}>Smartphone</div>
  ),
  Tablet: ({ size, className }: { size?: number; className?: string }) => (
    <div data-testid="tablet-icon" data-size={size} className={className}>Tablet</div>
  ),
