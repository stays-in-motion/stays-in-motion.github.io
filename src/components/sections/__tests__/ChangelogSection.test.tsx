...
const mockChangelogData = [
  {
    ...
    features: ['New workout categories', 'Improved playlist conversion speed'],
    improvements: ['Better error handling', 'Optimized memory usage'],
    bugfixes: ['Fixed timer sync issues', 'Resolved crash on large playlists'],
  },
  {
    version: '2.0.0',
    ...
    type: 'major',
    title: 'Major Release',
    features: ['Complete UI redesign', 'New authentication system'],
    breaking: ['API endpoints changed', 'Legacy data migration required'],
  },
  {
    version: '1.5.1',
    ...
    type: 'patch',
    title: 'Bug Fixes',
    bugfixes: ['Fixed login issues', 'Improved stability'],
  },
];
