...
mock.module("@/components/Navigation", () => ({
  Navigation: ({ activeSection }: { activeSection: string }) => (
    <nav data-testid="navigation" data-active-section={activeSection}>Navigation</nav>
  )
}));

mock.module("@/components/sections/HeroSection", () => ({
  HeroSection: ({ onDownloadClick, onLearnMoreClick }: { onDownloadClick: () => void, onLearnMoreClick: () => void }) => (
    <div data-testid="hero-section">
      <button onClick={onDownloadClick} data-testid="hero-download">Download</button>
      <button onClick={onLearnMoreClick} data-testid="hero-learn-more">Learn More</button>
    </div>
  )
}));
